...
abstract class MethodAnnotation {
  ...
  /**
   * The key for this Variable. If the annotation has an empty key then it uses the source
   * method's name as key.
   */
  ...
  /**
   * The name of the class refered to by {@code sourceClass}, that is, the class where that
  ...
  private void createBuilder(MethodSpec.Builder methodBuilder) {
    ...
    methodBuilder.addStatement("$L.setGlobal($S)", remixerItemName, global);
  ...
  /**
   * Adds all the code statements necessary to initialize a {@link RemixerItem} that corresponds
   * to the annotation.
   *
   * @param methodBuilder A Method builder has an instance of {@link Remixer} called {@code
   *                      remixer} and a context object called {@code activity}. This builder
   *                      corresponds to a method in the class that will contain the class
   *                      generated by {@link #generateCallbackClass()}.
   */
   ...
   *
   * @param methodBuilder A Method builder has an instance of {@link Remixer} called {@code
   *                      remixer} and a context object called {@code activity}. It also has a
   *                      {@link com.google.android.libraries.remixer.RemixerItem.Builder} called
   *                      {@code remixerItemName} that corresponds to this {@code
   *                      MethodAnnotation}. This method builder corresponds to a method in the
   *                      class that will contain the class generated by {@link
