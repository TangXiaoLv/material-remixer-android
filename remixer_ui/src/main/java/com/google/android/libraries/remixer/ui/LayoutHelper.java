...
public class LayoutHelper {
    ...
    public static CoordinatorLayout.LayoutParams createCoord(int width, float height, float leftMargin, float topMargin, float rightMargin, float bottomMargin) {
        CoordinatorLayout.LayoutParams layoutParams = new CoordinatorLayout.LayoutParams(getSize(width), getSize(height));
        layoutParams.setMargins(AndroidUtils.dp(leftMargin), AndroidUtils.dp(topMargin), AndroidUtils.dp(rightMargin), AndroidUtils.dp(bottomMargin));
        return layoutParams;
    }

    public static CoordinatorLayout.LayoutParams createCoord(int width, float height, CoordinatorLayout.Behavior behavior) {
        CoordinatorLayout.LayoutParams params = new CoordinatorLayout.LayoutParams(getSize(width), getSize(height));
        params.setBehavior(behavior);
        return params;
    }

    public static CoordinatorLayout.LayoutParams createCoord(int width, float height) {
